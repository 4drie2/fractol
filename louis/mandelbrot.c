...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/02 12:57:43 by lchauvet          #+#    #+#             */
/*   Updated: 2024/12/04 09:04:07 by lchauvet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline double	_mandelbrot(t_data data)
{
	double	iteration;
	double	y2;
	double	x2;
...
static void	_draw_mandelbrot(t_mlx *mlx)
{
	double		count;
	uint32_t	x;
	uint32_t	y;
